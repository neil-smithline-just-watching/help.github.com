...
* "GitHub Code Search":https://github.com/skratchdot/github-code-search.user.js - A user script that adds a search box to repository pages which allows you to search the code in that repository.
* "GitHub Fork Count":https://github.com/skratchdot/github-fork-count.user.js - A user script to display the fork count underneath the "public" repo count on a user's main profile page.
* "GitHub Repo Counts":https://github.com/skratchdot/github-repo-counts.user.js - A user script to display repo counts when browsing repository pages.
* "GitHub Repo-Filter Info":https://github.com/skratchdot/github-repo-filter-info.user.js - A user script to display some additional info below the repository filter on a user's main profile page.
* "Github Pull Request Links":https://github.com/skratchdot/github-pull-request-links.user.js - A user script to "linkify" the to/from branches on Pull Request pages.

h2. Gist

* "Replace page title with filename":http://gist.github.com/2794345
* "Diff for gist":http://gist.github.com/105913
* "ACE for gist":https://gist.github.com/raw/1368637/acegist.user.js — Replace textareas with ACE editors when editing your gists.
...
* "Printable GitHub issues":http://gist.github.com/1357711 - A print stylesheet for GitHub issues.

h2. Userscripts and Bookmarklets Needing an Owner and Updating

p. These userscripts and bookmarklets are no longer maintained. They do not work or do not work reliably. They need updating and, even better, a new maintainer.
